...
# 📊 مقيس على 450 صفقة مغلقة: النظام يفوز 54% ويخسر -639.2%،
#   لأنّنا نشتري ذروة الحماس وهي أسوأ توقيت:
#     شراء >70%       101 صفقة | فوز 52% | -4.56%/صفقة
#     ارتفاع ساعة >40% 36      | فوز 38% | -4.92%
#   وفي المقابل يربح المعتدل:
#     شراء 60-70%      95      | فوز 58% | +2.63%
#     ارتفاع 10-40%    36      | فوز 63% | +3.17%
#     ارتفاع سالب      88      | فوز 67% | +2.18%
#   وخفض العتبتين يقصّ 149 من 450 فيُحوّل -639.2% إلى +224.0%
#   وفوز 58%، وموجب في النصفين (+542 و +322).
MAX_BUY_RATIO = 0.70        # كان 0.85 — والقياس يقول 70%
MAX_PUMP_H1 = 40.0          # كان 200 — عتبة لا تمنع شيئاً عملياً
MAX_RUN_H6 = 150.0
MAX_DUMP = -30.0
SCORE_MIN = 88
