...
LOOKBACK = 20
MIN_DROP = 4.0
# 📊 مقيس 11 سبتمبر على 110 صفقة فيها RSI حقيقي (الحقل بدأ 10 سبتمبر):
#    RSI 18-21  n=12 فوز 66% متوسّط +2.31%  ← الافضل
#    RSI 21-24  n=18 فوز 33% متوسّط -0.14%
#    RSI 24-28  n=14 فوز 28% متوسّط -1.27%
#    RSI 28-36  n=43 فوز 27% متوسّط -0.88%  ← اكبر مصدر خسارة
#    كل شريحة فوق 24 خاسرة. والحد 35 يعطي -18، و24 يعطي +38.
RSI_MAX = 24.0
SL_PCT = 2.0
TP_PCT = 4.0
LEVERAGE = 5.0
