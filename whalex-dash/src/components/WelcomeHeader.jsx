...
const SOCIALS = [
  ...
  { id: "whatsapp", label: "WhatsApp", url: "https://chat.whatsapp.com/",                 bg: "rgba(37,211,102,0.13)" },
];
      ...
      {askPhone && (
        <div onClick={sharePhone} style={{
          ...
          <div style={{ fontSize: 12.5, lineHeight: 1.6, minWidth: 0 }}>
            <b style={{ color: "#25D366", display: "inline-flex", alignItems: "center", gap: 6 }}>
              ...
              {ar ? "انضم لمجموعة واتساب" : "Join our WhatsApp group"}
            </b>
