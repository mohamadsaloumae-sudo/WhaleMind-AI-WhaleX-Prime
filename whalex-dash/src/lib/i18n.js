...
export const TRANSLATIONS = {
  ar: {
    ...
    grantPro: "ترقية PRO",
    grantedPro: "تمّت الترقية لـ PRO ✓",
    ...
    "nav./trades": "صفقاتي",
    myLedger: "سجلّ تداولي",
    closedTrades: "صفقات مغلقة",
    openLbl: "مفتوحة",
    winRateLbl: "نسبة النجاح",
    winsLbl: "رابحة",
    lossesLbl: "خاسرة",
    netRealized: "صافي الربح الفعلي",
    "nav./api-guide": "دليل الاستخدام",
    "nav./history": "السجلّ الزمنيّ",
    "nav./live": "الصفقات المفتوحة",
    ...
    notifUnsupported: "متصفّحك لا يدعم الإشعارات.",
    notifEnable: "تفعيل الإشعارات",
    notifDisable: "إيقاف الإشعارات",
    notifOnMsg: "✅ تم تفعيل الإشعارات — ستصلك التنبيهات حتى والتطبيق مغلق",
    notifOffMsg: "تم إيقاف الإشعارات",
  ...
  en: {
    ...
    winsLbl: "Wins",
    lossesLbl: "Losses",
    netRealized: "Net realized profit",
    "nav./api-guide": "User Guide",
    "nav./history": "History",
    "nav./live": "Open Positions",
    ...
    notifDesc: "Get a notification on your phone for every new signal and position update — even when the app is closed.",
    ...
    notifOnMsg: "✅ Notifications enabled — you will get alerts even when the app is closed",
    notifOffMsg: "Notifications disabled",
