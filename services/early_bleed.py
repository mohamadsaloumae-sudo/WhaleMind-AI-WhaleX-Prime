...
# 📊 مقيس 13 سبتمبر على 946 صفقة — التوفير حسب النافذة:
#     3د: n= 31 فوز 3% · +147   ← كانت
#    10د: n=100 فوز 2% · +448
#    15د: n=124 فوز 2% · +529   ← المختارة
#    30د: n=162 فوز 3% · +620 (بلا فائدة اضافية تُذكر)
#    والفوز يبقى 2-3% في كل النوافذ — فالتمديد لا يقتل رابحات.
#    وخمس من سبع خسائر امس فاتت لانها تجاوزت 3 دقائق:
#    TAG 9د · CASHCAT 11.5د · HAJIMI 6.9د · GRIFFAIN 4.8د · 龙虾 3.2د
WINDOW_SEC = 900.0      # 15 دقيقة
