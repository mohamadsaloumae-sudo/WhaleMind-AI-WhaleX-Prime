...
# 📊 مقيس 12 سبتمبر على 111 صفقة سبوت منفّذة:
#    فوز 35% · معامل ربح 0.71 · صافي -22.2
#    والانفاق 5-10$ للصفقة، ورسوم السبوت 0.2% ذهابا وايابا.
#    فمتوسّط الربح -0.24% = 0.012$ على 5$ — والرسوم تساويه.
#    والاشارة نفسها رابحة في السجل (معامل 1.62)، فالفجوة من
#    الحجم لا من الاشارة.
MIN_SPEND = 50.0
_ADAPTERS = {}
