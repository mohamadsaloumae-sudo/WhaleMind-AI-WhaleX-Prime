...
_KEY_HOWTO = {
    ...
    "صلاحية العقود الآجلة غير مفعّلة": (
        ...
        "Enable Futures من إعدادات المفتاح في باينانس. وإن كانت "
        "مفعّلة أصلاً فالسبب أنّ محفظة العقود الآجلة لم تُفتح بعد "
        "على حسابك — افتحها من تطبيق باينانس ثمّ أعد المحاولة."),
}
