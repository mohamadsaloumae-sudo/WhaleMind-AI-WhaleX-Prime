...
MIN_TRADE_USD = 6.0         # 💵 حدّ باينانس الفعليّ 5$ ونحن 6$.
                            #   كان 20$ فيُحرَم كل حساب تحت 23$ من
                            #   كل الصفقات: رصيد 22.55$ − احتياطيّ 3$
                            #   = 19.55$ ÷ 20 = صفر مركز. فيفوته كل
                            #   شيء بفارق 45 سنتاً. مقيس اليوم: 3 رفضات
                            #   لرصيد 22.55$ و2 لرصيد 26.49$.
