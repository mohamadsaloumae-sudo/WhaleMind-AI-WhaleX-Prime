...
LEVERAGE = 5
MIN_TRADE = 20.0
# 📊 مقيس 12 سبتمبر على 227 صفقة حقيقية في 7 ايام:
#    التزامن ≤5 يغطي 82% من الفتحات · ≤6 يغطي 90% · ≤8 يغطي 96%
#    وكان 12 فيُحجز راس مال لا يُستعمل في 90% من الوقت.
#    والاثر: رصيد 300$ يفتح بـ37.5$ بدل 25$ — والرسوم تصير
#    0.4% من الهامش بدل 0.6%.
#    والحارس (margin_guard) يحمي: يمنع الصفقة التاسعة تلقائيا.
SLOTS = 8
RESERVE = 0.05
SUBSCRIPTION = 100.0
MIN_CAPITAL = 300.0
